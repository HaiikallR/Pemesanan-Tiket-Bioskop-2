                            ...
                            <div class="col-md-6">
                                <div class="modal-title">
                                    ...
                                    <p style="margin-right: 5px"
                                        ...
                                        {{ strftime('%d, %B, %Y', strtotime($item->tanggal_mulai)) }}
                                    </p>
                                    <p style="margin-right: 5px"
                                        class="badge text-bg-warning badge-genre text-light">
                                        {{ $item->detail->time->jam_mulai }}
                                        -{{ $item->detail->time->jam_selesai }}
                                    </p>
...
<div class="container mt-4">
    <div class="card">
        <h1 class="text-center text-secondary no-order-message" style="text-center">Histori Cancel</h1>
    </div>
